        ...
        >
            ...
            >
                <SelectDropdown
                    ...
                    style={{ width: '100%', height: '70px', borderColor: '#D9D9D9' }}
                    disabled={true}
                ...
                >
                    <InfoIcon sx={{ fontSize: '18px' }} /> Pending reviews and ratings
                </FormHelperText>
            </Box>
            <Box
                sx={{
            ...
            <InputField
                label="Feedback completed (90%)"
                defaultValue={'55'}
            />
            <InputField
                label="Invalid feedback (10%)"
                defaultValue={'45'}
            />
        </Box>
    )
