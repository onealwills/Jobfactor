...
const actionItems = [
    { label: 'Hide', icon: JobDetailItemTrashIcon },
    { label: 'Flag', icon: JobDetailItemFlagIcon },
    {
        label: 'Share',
        icon: JobDetailItemShareIcon
    },
    { label: 'Save', icon: JobDetailItemBookmarkIcon }
];
    ...
    return (
        <>
            ...
            >
                ...
                >
                    <Button variant="contained" sx={{ py: 1.5, px: 7 }}>
                        Apply
                    </Button>
                </Box>
            </Box>
