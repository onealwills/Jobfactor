...
import { IconButton, Grid, Box,Typography, Container, Button, ImageList, ImageListItem } from '@mui/material';
            ...
            <Grid container direction="column" gap={4}>
                ...
                <Grid item>
                    <Grid container wrap="nowrap" spacing={2}>
                        <Grid item xs={8}>
                            {data.map((feed) => <FeedItem feed={feed} />)}
                        </Grid>
                        <Grid item xs={4}>
                            <Section
                                heading={
                                ...
                                py={0}
                            >
                                <ImageList sx={{ width: '100%', height: "100%", borderRadius: '12px' }} cols={3}>
                                    {images.map((item) => (
                                        <ImageListItem>
                                            <img
                                                src={item}
                            ...
                            <Section
                                ...
                                py={'16px'}
                            >
                                {professionals.map(person => <ProfileList data={person} />)}
                            </Section>
